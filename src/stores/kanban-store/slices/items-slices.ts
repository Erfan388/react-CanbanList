...
export type ItemsSlice = {
    createItem: (boardId: string | undefined, listIndex: number, item: Omit<ListItemType, 'id' | "items">) => void;
    editItem: (boardId: string | undefined, listIndex: number, itemIndex: number, item: Partial<ListItemType >) => void;
    removeItem: (boardId: string | undefined, listIndex: number, itemIndex: number,) => void;
    moveItem: (boardId: string | undefined, activeListIndex: number, activeItemIndex: number, overItemIndex: number) => void;
    moveItemBetweenLists: (boardId: string | undefined, activeListIndex: number, activeItemIndex: number, overListIndex: number,overItemIndex: number) => void;
}
